...
import { createListing, updateListing, deleteListing, addListingReview } from '../controllers/listing.controller.js';
...
router.post('/merchant-products', protect, upload.single('photo'), createProductAdapter, createListing);
router.get('/merchant-products/:id', getProductById);
router.put('/merchant-products/:id', protect, upload.single('photo'), updateListing);
router.patch('/merchant-products/:id', protect, upload.single('photo'), updateListing);
router.delete('/merchant-products/:id', protect, deleteListing);

// --- STUDENT PRODUCTS ---
router.get('/student-products', getStudentProducts);
router.post('/student-products', protect, upload.single('photo'), createProductAdapter, createListing);
router.get('/student-products/:id', getProductById);
router.put('/student-products/:id', protect, upload.single('photo'), updateListing);
router.patch('/student-products/:id', protect, upload.single('photo'), updateListing);
router.delete('/student-products/:id', protect, deleteListing);

// --- TUTOR SERVICES ---
router.get('/tutor-services', getTutorServices);
router.post('/tutor-services', protect, upload.single('photo'), createProductAdapter, createListing);
router.get('/tutor-services/:id', getProductById);
router.put('/tutor-services/:id', protect, upload.single('photo'), updateListing);
router.patch('/tutor-services/:id', protect, upload.single('photo'), updateListing);
